class EnemiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @enemy.save
        format.html { redirect_to enemies_path, notice: "Enemy was successfully created." }
  ...
  def update
    respond_to do |format|
      if @enemy.update(enemy_params)
        format.html { redirect_to enemies_path, notice: "Enemy was successfully updated." }
  ...
  private
    ...
    def enemy_params
      params.require(:enemy).permit(:name, :has_killed)
    end
end
